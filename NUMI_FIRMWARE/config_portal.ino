...
static const char html_header[] PROGMEM =
  ...
  "<title>NUMI - DA2000 Numitron Clock</title>"
  "<style>"
  "html,body{margin:0;padding:0;font-size:16px;background:#100e07;}"
  ...
  ".container{margin:auto;padding:40px;max-width:600px;color:#fff;background:#000;box-shadow:0 0 100px #ffdc664a; border: 3px solid #ffdc66;border-radius:20px;}"
  ...
  "h2{color:#ffdc66;margin:30px 0 0 0;font-family:Arial,sans-serif;font-weight:300;font-size:1.5rem;}"
  ...
  "input[type=\"text\"]:hover,input[type=\"number\"]:hover,input[type=\"password\"]:hover,select:hover{border-color:#ffdc66;}"
  "input[type=\"text\"]:focus,input[type=\"password\"]:focus,select:focus{border-color:#a5fff3;}"
  "option{color:#000;}"
  "button{display:block;width:100%;padding: 15px 20px; margin-top: 40px;font-size:1rem;font-weight:700;text-transform:uppercase;background:#ffdc66;border:0;border-radius:5px;cursor:pointer;transition:.15s;outline:none;}"
  "button:hover{background:#ffe691;}"
  ".github{padding:15px;text-align:center;}.github a{color:#ffdc66;transition:.15s;}"
  ".github a:hover{color:#ffe691;}"
  ".github p{margin:0;}"
...
void handleRoot() {
  ...
  if (!server.args() || (server.args() && server.hasArg("is_form"))) {
    ...
    html += "<h1>NUMI - DA2000 Numitron Clock</h1> <p></p>";
